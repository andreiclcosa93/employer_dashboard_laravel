                            ...
                            <div class="col-12">
                                ...
                                <div class="page-title-right mb-2">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active text-info">Edit Product</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="tab-pane" id="settings">
                                                <form method="post" id="myForm" action="{{ route('product.update') }}" enctype="multipart/form-data">
                                                    @csrf
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="text" name="product_code" class="form-control @error('product_code') is-invalid @enderror" value="{{ $product->product_code }}">
                                                                @error('product_code')
                                                                <span class="text-danger"> {{ $message }} </span>
                                                                @enderror
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="text" name="product_garage" class="form-control @error('product_garage') is-invalid @enderror" value="{{ $product->product_garage }}">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="text" name="product_store" class="form-control @error('product_store') is-invalid @enderror" value="{{ $product->product_store }}">
                                                                @error('product_store')
                                                                <span class="text-danger"> {{ $message }} </span>
                                                                @enderror
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="text" name="buying_price" class="form-control @error('buying_price') is-invalid @enderror" value="{{ $product->buying_price }}">
                                                                @error('buying_price')
                                                                <span class="text-danger"> {{ $message }} </span>
                                                                @enderror
                                                            </div>
