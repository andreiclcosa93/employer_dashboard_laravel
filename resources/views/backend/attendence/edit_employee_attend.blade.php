                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between mb-2">
                                <h4 class="mb-sm-0">Edit Employee Attendance </h4>
                            </div>
                            <div class="page-title-right mb-2">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                                    <li class="breadcrumb-item"><a href="{{ route('employee.attend.list') }}">All Employee Attendence</a></li>
                                    <li class="breadcrumb-item active text-info">Edit Employee Attendance</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    <form action="{{ route('employee.attend.store') }}" method="post" id="myForm">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="date" name="date" id="date" class="checkdate form-control form-control-sm singledatepicker" placeholder="Attendance Date" value="{{ $editData['0']['date'] }}" autocomplete="off">
                                        </div>
                                        <br> <br>
