            ...
            <div class="content">
                ...
                <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between mb-2">
                                    <h4 class="mb-sm-0">Month Expense</h4>
                                </div>
                                <div class="page-title-right mb-2">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                                        <li class="breadcrumb-item"><a href="{{ route('add.expense') }}">Add Expense</a></li>
                                        <li class="breadcrumb-item active text-info">Month Expense</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="content">
                        ...
                        <!-- Start Content-->
                        <div class="container-fluid">
                            <h4 style=" font-size: 30px;" align="center" class="text-info"> Total : ${{ $expensemonth  }}</h4>
                            <div class="row">
